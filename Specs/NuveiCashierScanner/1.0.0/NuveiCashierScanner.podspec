Pod::Spec.new do |s|
  ...
  s.author                      = "Nuvei"
  s.source                      = { :git => "git@github.com:SafeChargeInternational/NuveiCashierScanner-iOS.git", :tag => s.version.to_s }
  s.platform                    = :ios, '10.0'
  s.requires_arc                = true
  ...
  s.resource_bundle             = { "NuveiCashierScanner" => ["NuveiCashierScanner/*.lproj"] }
